...
const createPost = (req,res,next) => {
    ...
    const {confNum, RTC,unitPrice,numNights,upgradedTo,revenue,commission,colleague,remark} = req.body;
...
const editPost = async (req, res, next) => {
    ...
    const {confNum, RTC, upgradedTo, unitPrice, numNights,revenue,commission,colleague,remark} = req.body;
